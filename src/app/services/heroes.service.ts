...
export class HeroesService {
  ...
  private heroes:Heroe[] = [
    {
      nombre: "Tormenta",
      intro:"Ororo puede volar, lanzar rayos, manipular la temperatura y hasta desatar un torbellino de gran potencia",
    ...
    {
      nombre: "Aquaman",
      intro: "El poder más reconocido de Aquaman es la capacidad telepática para comunicarse con la vida marina, la cual puede convocar a grandes distancias.",
    ...
    {
      nombre: "Batman",
      intro: "Los rasgos principales de Batman se resumen en «destreza física, habilidades deductivas y obsesión».",
    ...
    {
      nombre: "Daredevil",
      intro:"Al haber perdido la vista, los cuatro sentidos restantes de Daredevil fueron aumentados por la radiación a niveles superhumanos.",
    ...
    {
      nombre: "Hulk",
      intro: "Su principal poder es su capacidad de aumentar su fuerza hasta niveles prácticamente ilimitados a la vez que aumenta su furia.",
    ...
    },
    {
      ...
      intro: "Poseedor del anillo de poder que posee la capacidad de crear manifestaciones de luz sólida mediante la utilización del pensamiento.",
    ...
    {
      nombre: "Gamora",
      intro:"Thanos la sometió a tratamientos para elevar su nivel de poder y la entrenó para convertirse en una peligrosa combatiente cuerpo a cuerpo.",
    ...
    {
      nombre: "Spider-Man",
      intro: "Tras ser mordido por una araña radiactiva, obtuvo los siguientes poderes sobrehumanos, una gran fuerza, agilidad, poder trepar por paredes.",
    ...
    {
      nombre: "Wolverine",
      intro:"En el universo ficticio de Marvel, Wolverine posee poderes regenerativos que pueden curar cualquier herida, por mortal que ésta sea...",
    ...
    },
    {
      ...
      intro: "Después de ser infundido con el suero Super-Soldier, el cuerpo de Steve Roger alcanzó los límites más altos de la perfección humana en fuerza, resistencia, agilidad y durabilidad.",
    ...
    {
      nombre: "Iron Man",
      intro: "Genio. Multimillonario Playboy. Filántropo.",
    ...
    {
      nombre: "Flash",
      intro: "En la década de 1940, el estudiante universitario Jay Garrick adquirió sus habilidades de súper velocidad en un accidente de laboratorio al azar y se convirtió en el primer superhéroe de DC en llamarse Flash.",
    ...
    },
    {
      ...
      intro: "Alterado por los rayos cósmicos, todo el cuerpo de Reed Richards puede estirarse y expandirse de múltiples maneras, así como condensarse y compactarse.",
    ...
    {
      nombre: "Robín",
      intro: "Todos los niños quieren ser Batman, pero ¿tienes una vida de entrenamiento?",
    ...
    {
      nombre: "Shazam",
      intro: "Cuando Billy Batson dice el nombre de un viejo mago, se transforma en el mortal más poderoso del mundo: ¡Shazam!",
    ...
    {
      nombre: "Superman",
      intro: "Desde su uniforme azul hasta su capa roja que fluye hasta el escudo -S- en su pecho, Superman es uno de los Superhéroes DC más reconocidos y queridos de todos los tiempos.",
   ...
   { nombre: "Mujer Maravilla",
    intro:"Una de las mayores defensoras de la Paz en todo el mundo, Wonder Woman es también uno de los personajes más poderosos del Universo DC.",
    ...
    {
      nombre: "Cíclope",
      intro: "Cuando Scott Summers todavía era un niño, su padre llevaba a su familia a Canadá cuando su nave fue atacada por una nave espacial Shi'ar.",
    ...
    {
      nombre: "Hawkeye",
      intro: "los orígenes de Hawkeye no están vinculados con mutaciones, experimentos genéticos, ni accidentes radioactivos.",
      bio: "los orígenes de Hawkeye no están vinculados con mutaciones, experimentos genéticos, ni accidentes radioactivos. Por el contrario, Clint Barton era un huérfano que escapó de su orfanato para integrarse a un circo. Una vez ahí Clint fue cobijado por Swordsman y Trickshot, quienes lo entrenaron en el arte de las armas, pero lamentablemente el joven terminaría solo una vez más tras una serie de percances con ambos personajes. A pesar de estos dolorosos sucesos, Clint se inspiró en el accionar de Iron Man y decidió portar una máscara y utilizar sus habilidades para el bien. Sin embargo, el joven fue arrestado por la policía durante su primera noche como vigilante nocturno. En su versión Ultimate, Hawkeye asegura que sus habilidades se deben a su experiencia como arquero Olimpico, cuando lo cierto es que fue acusado de un crimen que no ha sido completamente explicado. A pesar de ello, sus habilidades resultaron fundamentales para que Nick Fury lo reclutara en su equipo de superhéroes.",
...
{
      nombre: "Raven",
      intro: "es extremadamente peligrosa para todos los Kryptonianos que son súper sensibles a la magia.",
...
{
      nombre: "Zatanna",
      intro:"Teóricamente esta superheroína puede vencer al mismísimo Superman.",
...
{
      nombre: "Mera",
      intro:"Mera es la esposa de Aquaman y la Reina de Atlantis y de los Océanos.",
...
{
      nombre: "Starfire",
      intro:"Starfire es una alienígena, y su lista de poderes es realmente impresionante.",
...
{
      nombre: "Black Widow",
      intro:"Natasha recibió una variante del Suero del Supersoldado  lo que hizo que sus capacidades físicas se elevaran al máximo.",
    ...
    },
{
      ...
      intro: "se especuló con que su poder se generaba a partir de la combinación de sus habilidades mutantes con la Magia del Caos.",
